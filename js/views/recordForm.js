    ...
    <div class="view view--form">
      ...
      <form id="record-form" class="form">
        <section class="form-section">
          <label class="form-label">誰との会話？</label>
          ...
          <p class="form-hint">選ばなくても保存できます。複数選択もできます。</p>
        </section>
        ...
        <section class="form-section form-section--hero">
          ...
          <textarea id="text-input" class="textarea textarea--hero" placeholder="ここに話したことを入力…">${escapeHtml(existing?.text || '')}</textarea>
          <p class="form-hint">キーボードのマイクボタンをタップすると、音声でそのまま入力できます。</p>
        </section>
        ...
        <details class="details-toggle">
          <summary>詳細を追加（タイトル・話題・重要事項）</summary>
          <div class="details-toggle__content">
            <section class="form-section">
              <label class="form-label form-label--muted" for="title-input">タイトル</label>
              <div class="input-with-button">
            ...
            <section class="form-section">
              <label class="form-label form-label--muted" for="topics-input">話題（カンマ区切り）</label>
              <input id="topics-input" type="text" value="${escapeHtml((existing?.topics || []).join(', '))}" placeholder="例：旅行, 映画">
            </section>

            <section class="form-section">
              <label class="form-label form-label--muted" for="keypoints-input">重要事項（カンマ区切り）</label>
